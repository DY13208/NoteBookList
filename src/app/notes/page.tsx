    ...
    <div className="bg-background-light dark:bg-background-dark text-s1-text-main dark:text-white font-jakarta overflow-x-hidden antialiased selection:bg-s1-flat-mint selection:text-black min-h-screen pb-24">
      <div className="max-w-md mx-auto border-x border-gray-100 dark:border-gray-800">
        ...
        <div className="fixed bottom-40 right-6 z-[110] flex flex-col items-end gap-3 pointer-events-none">
          {/* Expanded Actions */}
          <div className={`flex flex-col gap-3 transition-all duration-300 origin-bottom pointer-events-auto ${isAiExpanded ? 'scale-100 opacity-100 mb-2' : 'scale-0 opacity-0 h-0 pointer-events-none'}`}>
          ...
          <button
            ...
            className="w-24 h-24 relative group active:scale-95 transition-transform pointer-events-auto"
          >
