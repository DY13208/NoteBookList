      ...
      <div className="max-w-md mx-auto border-x border-gray-100 dark:border-gray-800">
        ...
        <main className="flex-1 flex flex-col gap-6 p-4">
          ...
          <section className="flex flex-col gap-4">
            ...
            {/* Note Card 1 */}
            <div onClick={() => router.push('/notes/neural-networks')} className="group relative flex flex-col sm:flex-row items-stretch gap-4 rounded-2xl bg-white dark:bg-[#1a2e1a] border-2 border-gray-100 dark:border-gray-800 p-4 hover:border-s1-flat-mint/50 transition-all cursor-pointer">
