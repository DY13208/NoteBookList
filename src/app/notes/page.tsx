          ...
          <section className="flex flex-col gap-4">
            ...
            <div className="group relative flex flex-col sm:flex-row items-stretch gap-4 rounded-2xl bg-white dark:bg-[#1a2e1a] border-2 border-gray-100 dark:border-gray-800 p-4 hover:border-s1-flat-mint/50 transition-all cursor-pointer">
              <div className="w-full sm:w-24 h-32 sm:h-auto shrink-0 rounded-xl overflow-hidden border-2 border-black relative">
                ...
                <div
                  className="w-full h-full bg-cover bg-center"
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCcw4VZKTbRArMhvd7foS1DnZYK33ZqkICZdWKbGdNiY919X7Qjpmur5cyXF2ptZ_ixQPnp6Qp4GZdDvEqVjAAVbhxG9QYg7hIPMim5mm0pj6JwrSPdUd7cmBtwQf9fHaZj5kgk9fwvW4-PrcAv4LHODDYhw2Hv689r4LRHj4-lcIfEnl4EXRnZyxc5Q70rgFeLPJc47lQMIlZTkIy2HKpc-Qwu4rXmhRhg0j_K3NkIIAHGVzDVpfsfNVvUbDUdANxqOqFHd1q9bX8")' }}
                ></div>
              </div>
              <div className="flex flex-col flex-1 justify-between gap-2">
                <div>
                  <div className="flex justify-between items-start">
                    <span className="bg-blue-100 text-blue-700 text-[10px] font-bold px-2 py-1 rounded-md mb-2 inline-block uppercase tracking-wider">草图</span>
                    <span className="material-symbols-outlined text-gray-400 group-hover:text-s1-flat-mint">bookmark_border</span>
                  </div>
                  <h4 className="text-lg font-bold leading-tight text-gray-900 dark:text-white mb-1">角色草图思路</h4>
                  <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">关于新角色的初步构思，包括 Chiikawa 风格的线条和比例。</p>
                </div>
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-xs font-bold text-gray-400 flex items-center gap-1">
            ...
            <div className="group relative flex flex-col sm:flex-row items-stretch gap-4 rounded-2xl bg-white dark:bg-[#1a2e1a] border-2 border-gray-100 dark:border-gray-800 p-4 hover:border-s1-flat-mint/50 transition-all cursor-pointer">
              <div className="w-full sm:w-24 h-32 sm:h-auto shrink-0 rounded-xl overflow-hidden border-2 border-black relative">
                <div className="absolute inset-0 bg-green-100/20 z-10"></div>
                <div
                  className="w-full h-full bg-cover bg-center"
              ...
              <div className="flex flex-col flex-1 justify-between gap-2">
                <div>
                  <div className="flex justify-between items-start">
                    <span className="bg-green-100 text-green-700 text-[10px] font-bold px-2 py-1 rounded-md mb-2 inline-block uppercase tracking-wider">医学</span>
                    <span className="material-symbols-outlined text-gray-400 group-hover:text-s1-flat-mint">bookmark_border</span>
                  </div>
                  <h4 className="text-lg font-bold leading-tight text-gray-900 dark:text-white mb-1">细胞学基础</h4>
                  <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">研究细胞的结构、功能和生命史，重点关注真核细胞。</p>
                </div>
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-xs font-bold text-gray-400 flex items-center gap-1">
