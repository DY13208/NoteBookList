          ...
          <section className="flex flex-col gap-4">
            ...
            >
              <div className="w-full sm:w-24 h-32 sm:h-auto shrink-0 rounded-xl overflow-hidden border-2 border-black relative">
                ...
                <div
                  className="w-full h-full bg-cover bg-center"
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCHr9oP0v_vYpS8Vf9nS1V0V6Xv7p9m8n7v6b5c4x3z2a1s0d9f8g7h6j5k4l3m2n1b0v9c8x7z6a5s4d3f2g1h0j9k8l7m6n5b4v3c2x1z0")' }}
                ></div>
              </div>
              <div className="flex flex-col flex-1 justify-between gap-2">
                <div>
                  <div className="flex justify-between items-start">
                    <span className="bg-blue-100 text-blue-700 text-[10px] font-bold px-2 py-1 rounded-md mb-2 inline-block uppercase tracking-wider">插画</span>
                    <span className="material-symbols-outlined text-gray-400 group-hover:text-s1-flat-mint">bookmark_border</span>
                  </div>
                  <h4 className="text-lg font-bold leading-tight text-gray-900 dark:text-white mb-1">角色草图思路</h4>
                  <p className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">关于吉伊卡哇及其伙伴们的各种表情和动作的速写草图及配色灵感。</p>
                </div>
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-xs font-bold text-gray-400 flex items-center gap-1">
