      ...
      <div className="fixed bottom-[96px] left-0 right-0 z-[110] transition-all duration-300 pointer-events-none">
        <div className="w-full max-w-md mx-auto pointer-events-auto">
          ...
          <div
            ...
            className="flex items-center justify-center mx-auto w-12 h-6 bg-white border-t border-x border-gray-200 rounded-t-xl cursor-pointer shadow-[0_-2px_10px_rgba(0,0,0,0.05)]"
          >
          ...
          <div className={`bg-white border-t border-gray-200 shadow-[0_-5px_20px_rgba(0,0,0,0.05)] overflow-hidden transition-all duration-300 ${isAiExpanded ? 'max-h-96 opacity-100 pt-4 pb-6 px-6' : 'max-h-0 opacity-0'}`}>
