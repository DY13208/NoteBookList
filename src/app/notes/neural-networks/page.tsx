...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div
        className={`fixed bottom-[100px] left-4 right-4 z-[110] transition-all duration-300 ease-in-out bg-white rounded-2xl border-2 border-gray-100 shadow-xl overflow-hidden ${
          isAiExpanded ? 'max-h-96 opacity-100' : 'max-h-14 opacity-90'
        }`}
      >
        <div className="w-full max-w-md mx-auto">
          ...
          {/* Collapsible Content */}
          <div className={`px-6 pb-6 transition-all duration-300 ${isAiExpanded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none h-0'}`}>
