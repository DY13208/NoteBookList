    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[96px] left-0 right-0 z-[110] pointer-events-none">
        <div className="w-full max-w-md mx-auto pointer-events-auto">
          <div className="bg-white border-2 border-black dark:border-white rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.12)] overflow-hidden transition-all duration-500 ease-in-out">
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full pt-4 pb-2 px-6 flex flex-col items-center gap-1.5 hover:bg-gray-50 transition-colors"
            >
              <div className="w-12 h-1.5 bg-gray-200 rounded-full"></div>
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-s4-flat-primary text-sm">auto_awesome</span>
                <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">AI 操作</h3>
              </div>
            </button>

            <div className={`px-6 pb-8 transition-all duration-500 ease-in-out overflow-hidden ${isAiExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
