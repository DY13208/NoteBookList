...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary pb-[96px]">
      {/* Header */}
          ...
          <div className="bg-white space-y-8 relative">
            ...
            <div className="relative z-10 border-l-4 border-s4-flat-primary pl-4 py-1">
              <p className="text-s4-flat-text text-lg leading-relaxed font-normal">
                神经网络是一系列算法，通过模仿{' '}
                <span className="bg-yellow-100 px-1 font-bold text-s4-flat-text">人脑</span>{' '}
                的过程来识别数据中的关系。
              </p>
            </div>
            ...
            <div className="rounded-xl bg-s4-flat-surface border border-gray-200 p-0 relative z-10 overflow-hidden">
              ...
              <div className="p-5 relative">
                ...
                <p className="text-s4-flat-text/80 leading-relaxed mb-6 pr-16 text-sm">
                  最简单的形式是 <span className="font-bold text-s4-flat-text">感知器</span>。一个带有权重和偏置的单神经元模型。
                </p>
      ...
      <div className="fixed bottom-[96px] left-0 right-0 z-[110] px-4 pointer-events-none">
        <div className="w-full max-w-md mx-auto bg-white rounded-2xl border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] pointer-events-auto overflow-hidden transition-all duration-300">
          <button
            onClick={() => setIsAiExpanded(!isAiExpanded)}
            className="w-full flex items-center justify-between px-6 py-3 border-b-2 border-black bg-s4-flat-primary/5 hover:bg-s4-flat-primary/10 transition-colors"
          >
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-s4-flat-primary">auto_awesome</span>
              <h3 className="text-sm font-black text-s4-flat-text uppercase tracking-wider">AI 操作</h3>
            </div>
          ...
          <div className={`transition-all duration-300 ease-in-out ${isAiExpanded ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
            <div className="grid grid-cols-3 gap-4 p-6 pt-4">
              <button className="group flex flex-col items-center w-full">
                <div className="w-full h-12 rounded-xl bg-s4-flat-primary border-2 border-black hover:-translate-y-1 transition-all flex items-center justify-center text-white mb-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none">
                  <span className="material-symbols-outlined text-2xl">segment</span>
                </div>
                <span className="text-[10px] font-black text-s4-flat-text uppercase tracking-tighter">摘要</span>
              </button>
              <button className="group flex flex-col items-center w-full">
                <div className="w-full h-12 rounded-xl bg-s4-flat-accent border-2 border-black hover:-translate-y-1 transition-all flex items-center justify-center text-white mb-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none">
                  <span className="material-symbols-outlined text-2xl">lightbulb</span>
                </div>
                <span className="text-[10px] font-black text-s4-flat-text uppercase tracking-tighter">提取</span>
              </button>
              <button className="group flex flex-col items-center w-full">
                <div className="w-full h-12 rounded-xl bg-s4-flat-yellow border-2 border-black hover:-translate-y-1 transition-all flex items-center justify-center text-black mb-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none">
                  <span className="material-symbols-outlined text-2xl">quiz</span>
                </div>
                <span className="text-[10px] font-black text-s4-flat-text uppercase tracking-tighter">测验</span>
              </button>
            </div>
          </div>
        </div>
