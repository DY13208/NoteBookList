    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
        ...
        <div className="px-6 pt-6 pb-2 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-2 mb-8 relative">
            ...
            <h1 className="text-4xl font-extrabold text-s4-flat-text leading-[1.1] font-display tracking-tight">
              神经网络
              <span className="block text-2xl font-semibold text-s4-flat-text-light mt-2">入门指南 101</span>
            </h1>
            ...
            <div className="rounded-xl bg-s4-flat-surface border border-gray-200 p-0 relative z-10 overflow-hidden">
              <div className="p-5 border-b border-gray-200 bg-gray-50/50 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-bold text-s4-flat-text text-lg font-display">感知机</h3>
                </div>
              ...
              <div className="p-5 relative">
                ...
                <p className="text-s4-flat-text/80 leading-relaxed mb-6 pr-16 text-sm">
                  最简单的形式是 <span className="font-bold text-s4-flat-text">感知机</span>。一个包含权重和偏置的单神经元模型。
                </p>
      ...
      <div className="fixed bottom-[96px] left-0 right-0 z-[110] pointer-events-none">
        <div className="w-full max-w-md mx-auto pointer-events-auto">
          <div className="bg-white border-2 border-black dark:border-white rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.1)] overflow-hidden transition-all duration-500 ease-in-out">
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full pt-4 pb-2 px-6 flex justify-between items-center hover:bg-gray-50 transition-colors"
            >
              <h3 className="text-sm font-black text-s4-flat-text-light uppercase tracking-wider flex items-center gap-2">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-500 ease-in-out ${isAiExpanded ? 'max-h-96 pb-8 pt-2 opacity-100' : 'max-h-0 opacity-0'}`}>
