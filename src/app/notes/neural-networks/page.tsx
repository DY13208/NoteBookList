    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pointer-events-none transition-all duration-300">
        <div className="w-full max-w-md mx-auto px-4">
          <div className="bg-white dark:bg-[#1a2e1a] rounded-2xl border-2 border-black dark:border-white shadow-bold pointer-events-auto overflow-hidden">
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full px-4 py-3 flex items-center justify-between bg-s1-flat-mint/10 dark:bg-s1-flat-mint/20 border-b-2 border-black/5 dark:border-white/5"
            >
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-s1-flat-mint">auto_awesome</span>
                <span className="text-sm font-black uppercase tracking-wider">AI 操作</span>
              </div>
            ...
            <div className={`transition-all duration-300 ease-in-out ${isAiExpanded ? 'max-h-96 opacity-100 p-4' : 'max-h-0 opacity-0'}`}>
              <div className="grid grid-cols-3 gap-4">
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-primary hover:bg-indigo-600 transition-colors flex items-center justify-center text-white mb-2 shadow-sm border-2 border-black/10">
                    <span className="material-symbols-outlined text-2xl">segment</span>
                  </div>
                  <span className="text-xs font-bold text-s4-flat-text dark:text-white">摘要</span>
                </button>
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-accent hover:bg-rose-600 transition-colors flex items-center justify-center text-white mb-2 shadow-sm border-2 border-black/10">
                    <span className="material-symbols-outlined text-2xl">lightbulb</span>
                  </div>
                  <span className="text-xs font-bold text-s4-flat-text dark:text-white">提取</span>
                </button>
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-yellow hover:bg-amber-600 transition-colors flex items-center justify-center text-white mb-2 shadow-sm border-2 border-black/10">
                    <span className="material-symbols-outlined text-2xl">quiz</span>
                  </div>
                  <span className="text-xs font-bold text-s4-flat-text dark:text-white">测验</span>
                </button>
              </div>
            </div>
          </div>
