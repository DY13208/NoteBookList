        ...
        <div className={`w-full max-w-md mx-auto px-6 pointer-events-auto`}>
          <div className="bg-white border-2 border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden transition-all duration-300">
            <button
              ...
              className="w-full pt-4 pb-2 px-6 flex justify-between items-center bg-gray-50 border-b border-gray-100"
            >
            ...
            <div className={`grid grid-cols-3 gap-4 px-6 pb-6 pt-4 transition-all duration-300 ${isAiExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden py-0'}`}>
