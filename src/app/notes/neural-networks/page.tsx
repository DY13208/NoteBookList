    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] transition-all duration-300 pointer-events-none">
        <div className="w-full max-w-md mx-auto px-4">
          <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden pointer-events-auto">
            {/* Header / Toggle */}
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full pt-4 pb-3 px-6 flex justify-between items-center bg-gray-50/50 hover:bg-gray-50 transition-colors border-b border-gray-100"
            >
