    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
          ...
          <div className="bg-white space-y-8 relative">
            ...
            <div className="relative z-10 border-l-4 border-s4-flat-primary pl-4 py-1">
              <p className="text-s4-flat-text text-lg leading-relaxed font-normal">
                神经网络是一系列模拟 <span className="bg-yellow-100 px-1 font-bold text-s4-flat-text">人类大脑</span> 工作过程，旨在识别数据中潜在关系的算法。
              </p>
            </div>
      ...
      <div className="fixed bottom-[96px] left-0 right-0 z-30 pointer-events-none">
        <div className="w-full max-w-md mx-auto px-6 pointer-events-auto">
          <div className="bg-white border-2 border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden transition-all duration-300">
            <button
            ...
            <div className={`grid grid-cols-3 gap-4 px-6 pb-6 overflow-hidden transition-all duration-300 ${isAiExpanded ? 'max-h-96 pt-2 opacity-100' : 'max-h-0 pt-0 opacity-0'}`}>
