...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
          ...
          <div className="bg-white space-y-8 relative">
            ...
            <div className="relative z-10 border-l-4 border-s4-flat-primary pl-4 py-1">
              <p className="text-s4-flat-text text-lg leading-relaxed font-normal">
                神经网络是一系列算法，通过模仿{' '}
                <span className="bg-yellow-100 px-1 font-bold text-s4-flat-text">人脑</span> 的过程来识别数据中的关系。
              </p>
            </div>
      ...
      {/* AI Action Bottom Bar - Fixed position above BottomNav */}
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] px-4 pointer-events-none">
        <div className="w-full max-w-md mx-auto bg-white border-2 border-gray-200 rounded-2xl shadow-xl overflow-hidden pointer-events-auto transition-all duration-300">
          <button
          ...
          >
            <h3 className="text-sm font-black text-s4-flat-text-light uppercase tracking-wider flex items-center gap-2">
              <span className="material-symbols-outlined text-s4-flat-primary text-lg">auto_awesome</span>
              AI 操作
            </h3>
          ...
          <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isAiExpanded ? 'max-h-96 opacity-100 pb-6 px-6' : 'max-h-0 opacity-0'}`}>
