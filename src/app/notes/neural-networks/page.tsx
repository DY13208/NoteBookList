  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[96px] left-0 right-0 z-30 pointer-events-none transition-all duration-300">
        <div className="w-full max-w-md mx-auto pointer-events-auto bg-white border-2 border-black rounded-t-3xl shadow-[0_-10px_25px_rgba(0,0,0,0.1)] overflow-hidden">
          <button
          ...
          <div className={`overflow-hidden transition-all duration-300 ${isAiExpanded ? 'max-h-96 opacity-100 pb-8' : 'max-h-0 opacity-0'}`}>
            <div className="grid grid-cols-3 gap-4 px-6 pt-2">
