  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] transition-all duration-300 pointer-events-none">
        <div className="w-full max-w-md mx-auto pt-4 pb-6 px-6 bg-white border-t-2 border-gray-100 rounded-t-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.08)] pointer-events-auto">
          <div
          ...
          <div className={`grid grid-cols-3 gap-4 transition-all duration-300 overflow-hidden ${isAiExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
