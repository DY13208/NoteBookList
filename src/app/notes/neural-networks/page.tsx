    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pointer-events-none transition-all duration-300">
        <div className="w-full max-w-md mx-auto px-4 pointer-events-auto">
          <div className="bg-white/95 backdrop-blur-md rounded-2xl border-2 border-gray-100 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] overflow-hidden transition-all duration-300">
            {/* Toggle Header */}
            <button
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xs font-black text-s4-flat-text-light uppercase tracking-wider">AI 操作</h3>
              </div>
            ...
            {/* Expandable Content */}
            <div className={`transition-all duration-300 ease-in-out ${isAiExpanded ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className="p-6 pt-4 grid grid-cols-3 gap-4">
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-primary hover:scale-105 active:scale-95 transition-all flex items-center justify-center text-white mb-2 shadow-lg shadow-s4-flat-primary/20">
                    <span className="material-symbols-outlined text-2xl">segment</span>
                  </div>
                  <span className="text-xs font-bold text-s4-flat-text">摘要</span>
                </button>
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-accent hover:scale-105 active:scale-95 transition-all flex items-center justify-center text-white mb-2 shadow-lg shadow-s4-flat-accent/20">
                    <span className="material-symbols-outlined text-2xl">lightbulb</span>
                  </div>
                  <span className="text-xs font-bold text-s4-flat-text">提取</span>
                </button>
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-yellow hover:scale-105 active:scale-95 transition-all flex items-center justify-center text-white mb-2 shadow-lg shadow-s4-flat-yellow/20">
