...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <main className="flex-1 overflow-y-auto w-full relative pb-80 scroll-smooth">
          ...
          <div className="bg-white space-y-8 relative">
            ...
            <div className="relative z-10 border-l-4 border-s4-flat-primary pl-4 py-1">
              <p className="text-s4-flat-text text-lg leading-relaxed font-normal">
                神经网络是一系列模拟<span className="bg-yellow-100 px-1 font-bold text-s4-flat-text">人类大脑</span>工作方式来识别数据中关系的算法。
              </p>
            </div>
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-30 px-4 pointer-events-none">
        <div className="w-full max-w-md mx-auto pointer-events-auto bg-white/95 backdrop-blur-md rounded-2xl border-2 border-gray-200 shadow-[0_-8px_30px_rgb(0,0,0,0.12)] overflow-hidden transition-all duration-300">
          {/* Header/Toggle */}
          <button
            onClick={() => setIsAiExpanded(!isAiExpanded)}
            className="w-full flex justify-between items-center px-6 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors"
          >
            <div className="flex items-center gap-2">
