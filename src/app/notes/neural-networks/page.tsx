    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pb-safe transition-all duration-300 pointer-events-none">
        <div className="w-full max-w-md mx-auto pointer-events-auto">
          <div className="bg-white border-t-2 border-x-2 border-gray-200 rounded-t-3xl shadow-[0_-10px_25px_rgba(0,0,0,0.05)] px-6 overflow-hidden">
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full pt-4 pb-2 flex flex-col items-center gap-1 group"
            >
              <div className="w-12 h-1.5 bg-gray-200 rounded-full group-hover:bg-s4-flat-primary transition-colors"></div>
              <h3 className="text-sm font-bold text-s4-flat-text-light uppercase tracking-wider">AI 操作</h3>
            </button>

            <div className={`grid grid-cols-3 gap-4 transition-all duration-500 ease-in-out ${isAiExpanded ? 'max-h-96 opacity-100 pb-8 mt-4' : 'max-h-0 opacity-0 pb-0 mt-0'}`}>
