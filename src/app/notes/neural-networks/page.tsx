    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pointer-events-none">
        <div className="w-full max-w-md mx-auto px-4">
          <div className={`bg-white/95 backdrop-blur-md rounded-2xl border-2 border-s4-flat-primary/20 shadow-lg transition-all duration-300 pointer-events-auto overflow-hidden`}>
            <div
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="flex justify-between items-center px-4 py-3 cursor-pointer hover:bg-gray-50 transition-colors border-b border-gray-100"
            >
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-s4-flat-primary text-[20px]">auto_awesome</span>
                <h3 className="text-xs font-black text-s4-flat-text uppercase tracking-wider">AI 操作</h3>
              </div>
            ...
            <div className={`transition-all duration-300 ${isAiExpanded ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className="grid grid-cols-3 gap-4 p-4">
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-primary hover:bg-indigo-600 transition-colors flex items-center justify-center text-white mb-2 shadow-md active:scale-95 transition-transform">
                ...
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-accent hover:bg-rose-600 transition-colors flex items-center justify-center text-white mb-2 shadow-md active:scale-95 transition-transform">
                    <span className="material-symbols-outlined text-2xl">lightbulb</span>
                  </div>
                  <span className="text-[10px] font-bold text-s4-flat-text uppercase">提取</span>
                </button>
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-12 rounded-xl bg-s4-flat-yellow hover:bg-amber-600 transition-colors flex items-center justify-center text-white mb-2 shadow-md active:scale-95 transition-transform">
