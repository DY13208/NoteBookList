...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pb-safe transition-all duration-300 pointer-events-none">
        <div className="w-full max-w-md mx-auto pt-4 pb-6 px-6 pointer-events-auto">
          <div
            onClick={() => setIsAiExpanded(!isAiExpanded)}
            className="flex justify-between items-center mb-4 bg-white/90 backdrop-blur-sm p-3 rounded-xl border border-gray-200 shadow-sm cursor-pointer hover:bg-gray-50 transition-colors"
          >
          ...
          <div className={`grid grid-cols-3 gap-4 bg-white border border-gray-200 rounded-2xl p-4 shadow-xl transition-all duration-300 overflow-hidden ${isAiExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 py-0 border-none'}`}>
