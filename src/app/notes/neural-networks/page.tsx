    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className={`fixed bottom-[96px] left-0 right-0 z-[110] transition-all duration-300 pointer-events-none`}>
        <div className="w-full max-w-md mx-auto px-6">
          <div className="bg-white rounded-2xl border-2 border-gray-100 shadow-bold-lg overflow-hidden pointer-events-auto">
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full flex justify-between items-center py-3 px-5 bg-gray-50/50 hover:bg-gray-50 transition-colors"
            >
            ...
            <div className={`transition-all duration-300 ease-in-out ${isAiExpanded ? 'max-h-40 opacity-100 py-4 px-5' : 'max-h-0 opacity-0 overflow-hidden'}`}>
