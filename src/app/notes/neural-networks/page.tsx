  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] px-4 pointer-events-none">
        <div className="w-full max-w-md mx-auto bg-white rounded-2xl border-2 border-gray-100 shadow-xl overflow-hidden pointer-events-auto transition-all duration-300 ease-in-out">
          {/* Header Toggle */}
          <div
            onClick={() => setIsAiExpanded(!isAiExpanded)}
            className="flex items-center justify-between px-6 py-3 bg-gray-50/80 cursor-pointer hover:bg-gray-100/80 transition-colors"
          >
            <div className="flex items-center gap-2">
          ...
          {/* Action Grid */}
          <div className={`transition-all duration-300 ease-in-out overflow-hidden ${isAiExpanded ? 'max-h-96 opacity-100 py-4' : 'max-h-0 opacity-0'}`}>
