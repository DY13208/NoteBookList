        ...
        <div className="w-full max-w-md mx-auto pt-4 pb-6 px-6 pointer-events-auto">
          <div className="bg-white border-2 border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
            <div
              ...
              className="flex justify-between items-center px-4 py-3 bg-gray-50 border-b-2 border-black cursor-pointer"
            >
            ...
            <div className={`transition-all duration-300 ease-in-out overflow-hidden ${isAiExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}>
