  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-4 right-4 z-[110] transition-all duration-300 pointer-events-none">
        <div className="w-full max-w-md mx-auto bg-white/95 backdrop-blur-md rounded-2xl border-2 border-gray-100 shadow-[0_-5px_20px_rgba(0,0,0,0.1)] p-4 pointer-events-auto overflow-hidden">
          <div
            className="flex justify-between items-center mb-0 cursor-pointer"
            onClick={() => setIsAiExpanded(!isAiExpanded)}
          >
            <h3 className="text-xs font-black text-[#f4257b] uppercase tracking-widest flex items-center gap-2">
          ...
          <div className={`grid grid-cols-3 gap-4 transition-all duration-300 ease-in-out ${isAiExpanded ? 'mt-4 opacity-100 max-h-40' : 'mt-0 opacity-0 max-h-0'}`}>
            <button className="group flex flex-col items-center w-full">
              <div className="w-full h-12 rounded-xl bg-s4-flat-primary hover:bg-indigo-600 transition-colors flex items-center justify-center text-white mb-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)]">
                <span className="material-symbols-outlined text-2xl">segment</span>
              </div>
              <span className="text-[10px] font-bold text-s4-flat-text uppercase">摘要</span>
            </button>
            <button className="group flex flex-col items-center w-full">
              <div className="w-full h-12 rounded-xl bg-s4-flat-accent hover:bg-rose-600 transition-colors flex items-center justify-center text-white mb-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)]">
                <span className="material-symbols-outlined text-2xl">lightbulb</span>
              </div>
              <span className="text-[10px] font-bold text-s4-flat-text uppercase">提取</span>
            </button>
            <button className="group flex flex-col items-center w-full">
              <div className="w-full h-12 rounded-xl bg-s4-flat-yellow hover:bg-amber-600 transition-colors flex items-center justify-center text-white mb-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)]">
