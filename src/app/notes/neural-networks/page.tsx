        ...
        <div className="w-full max-w-md mx-auto px-6 pointer-events-auto">
          <div className="bg-white border-2 border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
            <button
              ...
              className="w-full flex justify-between items-center px-5 py-3 bg-gray-50 border-b border-gray-100"
            >
            ...
            <div className={`transition-all duration-300 overflow-hidden ${isAiExpanded ? 'max-h-40 opacity-100 py-4 px-5' : 'max-h-0 opacity-0'}`}>
