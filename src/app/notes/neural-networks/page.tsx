    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pointer-events-none">
        <div className="w-full max-w-md mx-auto pointer-events-auto">
          <div className="bg-white border-2 border-black rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.12)] overflow-hidden transition-all duration-500 ease-in-out">
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full pt-4 pb-2 px-6 flex items-center justify-between hover:bg-gray-50 transition-colors"
            >
              <div className="flex items-center gap-2">
                <div className="size-2 rounded-full bg-s4-flat-primary animate-pulse"></div>
                <h3 className="text-sm font-black text-s4-flat-text uppercase tracking-widest">AI 操作</h3>
              </div>
            ...
            <div className={`px-6 pb-8 transition-all duration-500 ease-in-out overflow-hidden ${isAiExpanded ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className="grid grid-cols-3 gap-4 mt-2">
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-14 rounded-2xl bg-s4-flat-primary hover:bg-indigo-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold hover:-translate-y-1 active:translate-y-0 active:shadow-none">
                ...
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-14 rounded-2xl bg-s4-flat-accent hover:bg-rose-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold hover:-translate-y-1 active:translate-y-0 active:shadow-none">
                ...
                <button className="group flex flex-col items-center w-full">
                  <div className="w-full h-14 rounded-2xl bg-s4-flat-yellow hover:bg-amber-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold hover:-translate-y-1 active:translate-y-0 active:shadow-none">
