...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className={`fixed bottom-0 left-0 right-0 z-30 pb-safe transition-all duration-300 bg-white border-t-2 border-gray-100 dark:border-white/10 ${isAiExpanded ? 'translate-y-0' : 'translate-y-[calc(100%-48px)]'}`}>
        <div className="w-full max-w-md mx-auto">
          ...
          <div className={`pt-4 pb-10 px-6 transition-opacity duration-300 ${isAiExpanded ? 'opacity-100' : 'opacity-0'}`}>
