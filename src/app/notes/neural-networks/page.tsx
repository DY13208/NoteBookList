...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary pb-[100px]">
      {/* Header */}
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] transition-all duration-500 pointer-events-none">
        <div className="w-full max-w-md mx-auto px-4 pointer-events-auto">
          <div className="bg-white dark:bg-[#1a0c11] rounded-2xl border-2 border-gray-100 dark:border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] overflow-hidden">
            {/* Toggle Header */}
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full flex items-center justify-between px-6 py-3 bg-gray-50/50 dark:bg-white/5 border-b border-gray-100 dark:border-white/5 group"
            >
              <div className="flex items-center gap-2">
                <div className="size-2 rounded-full bg-s1-flat-mint animate-pulse"></div>
                <h3 className="text-xs font-black text-s4-flat-text-light uppercase tracking-widest">AI 操作</h3>
              </div>
            ...
            {/* Actions Grid */}
            <div
              className={`grid grid-cols-3 gap-4 px-6 transition-all duration-500 ease-in-out ${
                isAiExpanded ? 'max-h-32 opacity-100 py-6' : 'max-h-0 opacity-0 py-0'
              }`}
            >
              <button className="group flex flex-col items-center w-full">
                <div className="w-full h-12 rounded-xl bg-s4-flat-primary hover:bg-indigo-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold-sm active:translate-y-1 active:shadow-none">
                  <span className="material-symbols-outlined text-2xl">segment</span>
                </div>
                <span className="text-[10px] font-black text-s4-flat-text uppercase tracking-wider">摘要</span>
              </button>
              <button className="group flex flex-col items-center w-full">
                <div className="w-full h-12 rounded-xl bg-s4-flat-accent hover:bg-rose-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold-sm active:translate-y-1 active:shadow-none">
                  <span className="material-symbols-outlined text-2xl">lightbulb</span>
                </div>
                <span className="text-[10px] font-black text-s4-flat-text uppercase tracking-wider">提取</span>
              </button>
              <button className="group flex flex-col items-center w-full">
                <div className="w-full h-12 rounded-xl bg-s4-flat-yellow hover:bg-amber-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold-sm active:translate-y-1 active:shadow-none">
                  <span className="material-symbols-outlined text-2xl">quiz</span>
                </div>
                <span className="text-[10px] font-black text-s4-flat-text uppercase tracking-wider">测验</span>
              </button>
            </div>
          </div>
        </div>
