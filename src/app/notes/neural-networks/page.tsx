  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pointer-events-none transition-all duration-300">
        <div className="w-full max-w-md mx-auto pointer-events-auto bg-white border-2 border-black rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.1)] overflow-hidden">
          <button
          ...
          <div className={`transition-all duration-300 ease-in-out px-6 overflow-hidden ${isAiExpanded ? 'max-h-40 opacity-100 pb-6' : 'max-h-0 opacity-0 pb-0'}`}>
