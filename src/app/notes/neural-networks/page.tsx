    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pointer-events-none transition-all duration-300">
        <div className="w-full max-w-md mx-auto px-4 pointer-events-auto">
          <div className="bg-white dark:bg-[#1a0c11] border-2 border-black dark:border-white/20 rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
            <button
              onClick={() => setIsAiExpanded(!isAiExpanded)}
              className="w-full flex items-center justify-between px-5 py-3 bg-gray-50 dark:bg-white/5 border-b-2 border-black/5"
            >
              <div className="flex items-center gap-2">
            ...
            <div className={`transition-all duration-300 ease-in-out overflow-hidden ${isAiExpanded ? 'max-h-96 opacity-100 pt-4 pb-6 px-6' : 'max-h-0 opacity-0'}`}>
