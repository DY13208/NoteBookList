    ...
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className={`fixed bottom-[96px] left-0 right-0 z-[110] transition-all duration-300 pointer-events-none`}>
        <div className="w-full max-w-md mx-auto px-6">
          <div className={`bg-white border-2 border-gray-200 rounded-2xl shadow-lg overflow-hidden pointer-events-auto transition-all duration-300 ${isAiExpanded ? 'max-h-96' : 'max-h-12'}`}>
            <div
            ...
            <div className={`grid grid-cols-3 gap-4 px-4 pb-6 transition-all duration-300 ${isAiExpanded ? 'opacity-100' : 'opacity-0'}`}>
