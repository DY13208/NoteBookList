  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className="fixed bottom-[100px] left-0 right-0 z-[110] pb-safe pointer-events-none">
        <div className="w-full max-w-md mx-auto bg-white border-2 border-black rounded-t-3xl shadow-[0_-10px_30px_rgba(0,0,0,0.1)] pointer-events-auto overflow-hidden transition-all duration-300">
          {/* Toggle Header */}
          <button
          ...
          <div className={`px-6 pb-6 transition-all duration-300 ease-in-out overflow-hidden ${isAiExpanded ? 'max-h-40 opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
