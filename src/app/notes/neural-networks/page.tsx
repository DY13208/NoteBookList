...
export default function AINotebook() {
  ...
  return (
    <div className="text-s4-flat-text antialiased overflow-hidden h-screen flex flex-col font-sans bg-s4-flat-bg selection:bg-s4-flat-primary/20 selection:text-s4-flat-primary">
      ...
      <div className={`fixed bottom-[96px] left-0 right-0 z-30 transition-all duration-300 ${isAiExpanded ? 'translate-y-0' : 'translate-y-[calc(100%-48px)]'}`}>
        <div className="w-full max-w-md mx-auto bg-white/95 backdrop-blur-md border-2 border-black rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.1)] overflow-hidden">
          ...
          <button
            ...
            className="w-full pt-3 pb-2 flex flex-col items-center gap-1 hover:bg-gray-50 transition-colors"
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`material-symbols-outlined text-xs transition-transform duration-300 ${isAiExpanded ? 'rotate-180' : ''}`}>expand_less</span>
            </div>
          </button>
          ...
          <div className="px-6 pb-8 pt-2">
            <div className="grid grid-cols-3 gap-4">
              <button className="group flex flex-col items-center w-full active:scale-95 transition-transform">
                <div className="w-full h-14 rounded-2xl bg-s4-flat-primary hover:bg-indigo-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold-sm border-2 border-black">
                  <span className="material-symbols-outlined text-2xl">segment</span>
                </div>
                <span className="text-xs font-black text-s4-flat-text uppercase tracking-wider">摘要</span>
              </button>
              <button className="group flex flex-col items-center w-full active:scale-95 transition-transform">
                <div className="w-full h-14 rounded-2xl bg-s4-flat-accent hover:bg-rose-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold-sm border-2 border-black">
                  <span className="material-symbols-outlined text-2xl">lightbulb</span>
                </div>
                <span className="text-xs font-black text-s4-flat-text uppercase tracking-wider">提取</span>
              </button>
              <button className="group flex flex-col items-center w-full active:scale-95 transition-transform">
                <div className="w-full h-14 rounded-2xl bg-s4-flat-yellow hover:bg-amber-600 transition-all flex items-center justify-center text-white mb-2 shadow-bold-sm border-2 border-black">
                  <span className="material-symbols-outlined text-2xl">quiz</span>
                </div>
                <span className="text-xs font-black text-s4-flat-text uppercase tracking-wider">测验</span>
              </button>
            </div>
          </div>
        </div>
