        ...
        <div className="p-4 space-y-6 pb-32">
          ...
          <div className="w-full flex flex-col overflow-hidden rounded-2xl bg-[#FFF0F5] dark:bg-pink-900/20 border-2 border-s3-primary/20 dark:border-s3-primary/40 shadow-none">
            ...
            <div className="p-5 flex flex-col items-center text-center bg-[#FFF0F5] dark:bg-transparent border-t-2 border-s3-primary/10">
              <h1 className="text-2xl font-black text-s3-primary mb-1 tracking-tight">欢迎！</h1>
              <p className="text-slate-600 dark:text-pink-100 font-bold text-sm">在这里使用你的积分兑换好礼。</p>
            </div>
          </div>
          ...
          <Link href="/points" className="flex flex-col items-center justify-center py-4 bg-s3-surface dark:bg-white/5 rounded-2xl border-2 border-transparent hover:border-s3-primary/30 transition-all cursor-pointer group">
            <div className="bg-s3-primary/10 dark:bg-s3-primary/30 px-4 py-1.5 rounded-lg mb-2 group-hover:bg-s3-primary group-hover:text-white transition-colors">
              <p className="text-xs font-black uppercase tracking-widest">当前余额</p>
            </div>
            ...
            <div className="mt-2 text-xs font-bold text-s3-primary flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
              查看积分看板 <span className="material-symbols-outlined text-xs">arrow_forward</span>
            </div>
          </Link>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h3 className="text-slate-900 dark:text-white text-xl font-extrabold tracking-tight">主题</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="group flex flex-col gap-3 p-3 bg-white dark:bg-white/5 rounded-2xl border-2 border-gray-100 dark:border-white/10 hover:border-s3-primary/50 transition-colors">
                ...
                <div className="flex flex-col px-1">
                  <h4 className="text-slate-900 dark:text-white font-black text-base">粉红兔兔</h4>
                  <div className="flex items-center gap-1 text-s3-primary mt-1">
                    <span className="text-xs font-black bg-s3-primary/10 px-2 py-1 rounded text-s3-primary">500 积分</span>
                  </div>
                </div>
              ...
              <div className="group flex flex-col gap-3 p-3 bg-white dark:bg-white/5 rounded-2xl border-2 border-gray-100 dark:border-white/10 hover:border-s3-primary/50 transition-colors">
                ...
                <div className="flex flex-col px-1">
                  <h4 className="text-slate-900 dark:text-white font-black text-base">深海小八</h4>
                  <div className="flex items-center gap-1 text-s3-primary mt-1">
                    <span className="text-xs font-black bg-s3-primary/10 px-2 py-1 rounded text-s3-primary">750 积分</span>
                  </div>
                </div>
                <Link href="/shop/success" className="w-full h-10 rounded-lg bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-sm font-extrabold hover:bg-slate-700 transition-colors flex items-center justify-center active:scale-95">
                  兑换
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h3 className="text-slate-900 dark:text-white text-xl font-extrabold tracking-tight">应用图标</h3>
            </div>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-4 rounded-2xl bg-white dark:bg-white/5 p-3 border-2 border-gray-100 dark:border-white/10 hover:border-s3-primary/50 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-slate-900 dark:text-white font-black text-base truncate">吉伊脸谱</h4>
                  <p className="text-slate-500 text-xs font-bold uppercase tracking-wide">12款定制图标</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-white dark:bg-white/5 p-3 border-2 border-gray-100 dark:border-white/10 hover:border-s3-primary/50 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-slate-900 dark:text-white font-black text-base truncate">魔法棒</h4>
                  <p className="text-slate-500 text-xs font-bold uppercase tracking-wide">8款定制图标</p>
                </div>
                <button className="h-9 bg-s3-primary/10 text-s3-primary px-4 rounded-lg text-xs font-black hover:bg-s3-primary hover:text-white transition-colors uppercase">
                  250 积分
                </button>
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-gray-50 dark:bg-white/5 p-3 border-2 border-transparent opacity-60">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-slate-900 dark:text-white font-black text-base truncate">黄金星星</h4>
                  <p className="text-slate-500 text-xs font-bold uppercase tracking-wide">需达到 10级</p>
                </div>
