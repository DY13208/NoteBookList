  ...
  return (
    <div className="font-nunito antialiased min-h-screen pb-32 bg-s1-bg-base text-s1-text-main selection:bg-s1-flat-pink selection:text-white">
            ...
            <div className="absolute -top-12 -right-2 z-20 animate-float">
              <div className="relative flex flex-col items-center">
                <div className="bg-white px-3 py-1 rounded-lg border-2 border-s1-text-main mb-1">
                  <span className="text-xs font-black text-s1-text-main">呀哈！！</span>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col w-full">
                <div className="flex justify-between items-start">
                  <p className="text-s1-text-main text-lg font-black leading-tight font-rounded">Python 第 4 章</p>
      ...
      <div className="px-6 pb-24">
        ...
        <div className="flex flex-col gap-3">
          <Link href="/notes/neural-networks" className="group flex items-center gap-4 bg-s1-surface rounded-2xl p-3 pr-4 cursor-pointer hover:bg-gray-100 transition-colors">
            ...
            <div className="flex flex-1 flex-col justify-center">
              <h4 className="font-rounded text-md font-black text-s1-text-main line-clamp-1">神经网络 101</h4>
              <div className="flex items-center gap-2 mt-1">
                <span className="rounded px-1.5 py-0.5 text-[10px] font-black text-white bg-s1-flat-blue uppercase">笔记</span>
                <span className="text-xs text-s1-text-sub font-bold">2 小时前</span>
              </div>
            </div>
