    ...
    <div className="font-nunito antialiased min-h-screen pb-32 bg-s1-bg-base text-s1-text-main selection:bg-s1-flat-pink selection:text-white">
      ...
      <div className="px-6 mb-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/notes">
            <button className="text-xs font-black text-s1-flat-blue uppercase bg-s1-flat-blue/10 px-3 py-1.5 rounded-lg hover:bg-s1-flat-blue hover:text-white transition-colors cursor-pointer">
              See All
            </button>
          </Link>
        </div>
