...
export default function TrophyRoom() {
  ...
  const achievements: Achievement[] = [
    {
      ...
      bg: 'bg-[#FFF5F9]',
      date: '2023.10.27',
      fullDesc: "你已经写了100篇高质量笔记！呀哈！继续保持！",
      rarityBadge: "传说",
      rarityBg: "bg-[#FFD700]"
    },
    {
  ...
  return (
    <div className="bg-[#f8f5f7] dark:bg-[#221017] font-jakarta text-[#181114] dark:text-white antialiased min-h-screen pb-32">
      {/* TopAppBar */}
      ...
      <div className="px-6 pt-2 pb-4">
        <h1 className="text-[32px] font-extrabold leading-tight tracking-tight text-[#f4257b]">成就</h1>
        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1">收集所有成就，成为大师！</p>
      </div>
      ...
      <div className="px-6 pb-6">
        <div className="bg-white dark:bg-[#2f1b25] border-2 border-gray-100 dark:border-gray-800 rounded-xl p-5 shadow-sm">
          <div className="flex justify-between items-end mb-3">
            <div>
              <p className="text-base font-bold leading-normal">总完成度</p>
              <p className="text-[#f4257b] text-xs font-bold mt-1 uppercase tracking-wider">5级学者</p>
            </div>
          ...
          <div className="flex justify-between mt-2">
            <p className="text-gray-400 text-xs font-bold">15/20 已解锁</p>
            <p className="text-gray-400 text-xs font-bold">剩余 5</p>
          </div>
        </div>
      </div>
            ...
            <div className={`flex ${item.isWide ? 'flex-row items-center gap-4 h-full' : 'flex-col gap-3'}`}>
              ...
              <div className="flex-1">
                {item.unlocked ? (
                  ...
                  <>
                    <div className="flex items-center gap-1 mb-1">
                      <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">未解锁</p>
                    </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="relative w-full max-w-sm bg-white dark:bg-[#2d1b22] rounded-xl border-[3px] border-[#221017] dark:border-white/20 shadow-[4px_4px_0px_0px_#221017] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)] overflow-hidden flex flex-col animate-pop-up-bounce">
            ...
            <div className="flex items-center justify-between bg-white dark:bg-[#2d1b22] px-5 py-4 border-b-[3px] border-[#f8f5f7] dark:border-white/10">
              <h2 className="text-[#221017] dark:text-white text-lg font-bold uppercase tracking-tight">成就解锁</h2>
              <button
            ...
            <div className="flex flex-col items-center p-6 text-center">
              ...
              {/* Meta Text */}
              <p className="text-[#8a6072] dark:text-[#dcbccc] text-sm font-bold uppercase tracking-wide mb-5">获得日期: {selectedAchievement.date || '2023.10.27'}</p>
              ...
              <div className="flex justify-center mb-6">
                <div className={`flex items-center gap-x-2 px-5 py-2 rounded-lg ${selectedAchievement.rarityBg || 'bg-[#FFD700]'} border-2 border-[#221017] shadow-[2px_2px_0px_0px_#221017] transform -rotate-2 hover:rotate-0 transition-transform duration-200`}>
                  ...
                  <p className="text-[#221017] text-sm font-extrabold uppercase tracking-wider">稀有度: {selectedAchievement.rarityBadge || selectedAchievement.rarity}</p>
                </div>
              </div>

              {/* Description */}
              <p className="text-[#221017]/90 dark:text-white/90 text-lg font-medium leading-relaxed mb-8 px-2">
                {selectedAchievement.fullDesc || selectedAchievement.desc} <br/> <span className="text-[#f4257b] font-bold">呀哈！</span>继续努力！
              </p>
